...
systems using the causal consistency. TODO: Seems an obsolete statement as
there is Dynamo paper and Riak, Cassandra, Voldemort per-key causal consistent
a-like distributed hash tables exist as of today!
