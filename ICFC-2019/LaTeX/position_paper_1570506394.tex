...
Speaking more of Telcos and dynamic Mobile Edge Computing (MEC) environments,
there is also high demand for modern lightweight latency-tolerant data
replication and live migration solutions performing well over backbone wide
area networks (WANs) and not being DC-centric. The related work\cite{b15}
